...
mod tests {
    ...
    fn test_garch_fits() {
        ...
        let returns: Vec<f64> = vec![
            0.01, -0.02, 0.005, 0.03, -0.01, 0.02, -0.015, 0.008,
            0.025, -0.03, 0.01, 0.015, -0.02, 0.005, 0.04, -0.025,
            0.012, -0.008, 0.02, 0.01, -0.015, 0.03, -0.01, 0.005,
            0.018, -0.022, 0.008, 0.025, -0.012, 0.015,
        ];
